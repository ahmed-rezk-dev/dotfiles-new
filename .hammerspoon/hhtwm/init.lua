...
module.getLayout = function(spaceId)
    ...
    return cache.layouts[spaceId] or (screen and module.displayLayouts and module.displayLayouts[screen:id()]) or (screen and module.displayLayouts and module.displayLayouts[screen:name()]) or "monocle"
end
        ...
        hs.fnutils.each(hs.screen.allScreens(), function(screen)
            ...
            if not layoutName or not layouts[layoutName] then
                ...
                for index, window in pairs(screenWindows) do
                    local frame = layouts[layoutName](window, screenWindows, screen, index, cache.layoutOptions[spaceId] or getDefaultLayoutOptions())
