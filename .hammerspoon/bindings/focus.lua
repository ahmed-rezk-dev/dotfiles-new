...
module.start = function()
  ...
  hs.hotkey.bind({ 'ctrl', 'alt' }, 'u', function() cycleWindows('next', APP_WINDOWS_ONLY, SCREEN_WINDOWS_ONLY) end)
  hs.hotkey.bind({ 'ctrl', 'alt' }, 'y', function() cycleWindows('prev', APP_WINDOWS_ONLY, SCREEN_WINDOWS_ONLY) end)
end
